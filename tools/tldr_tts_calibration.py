...
CAPABILITIES={
 ...
 "x-ai/grok-voice-tts-1.0":{"provider":"xai","host":"eve","analyst":"rex","english_voices":{"eve","ara","rex","sal","leo"},"source":"https://openrouter.ai/x-ai/grok-voice-tts-1.0","formats":set(),"requested_format":None,"accepted_mime":None,"native_codec":None,"sample_rate":None,"channels":None,"transcoded":None,"speed":False,"provider_passthrough":False,"canary_proven":False,"pricing_unit":"characters","speech_endpoint":True,"max_input":15000},
